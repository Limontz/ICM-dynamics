...
output1=string("/home/marco/Scrivania/Ettori_project/",name[l],"/300_kpc_filtering/new_",name[l],"_3D_box_filtering_fit_parameters.txt")
out1=open(output1,"w") do out1
write( out1, ans)
end
close(output1)

output1=file1=string("/home/marco/Scrivania/Ettori_project/",name[l],"/300_kpc_filtering/new_",name[l],"_3D_box_filtering_fit_parameters.txt")
