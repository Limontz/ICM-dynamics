...
pcolormesh((-Ncell*dx:dx:Ncell*dx),(-Ncell*dx:dx:Ncell*dx),(((d_2D[xc-Ncell:xc+Ncell,yc-Ncell:yc+Ncell]))))
...
Npoint=length(d_2D[1,xc-Ncell:xc+Ncell])
...
subplot(1,2,2)
pcolormesh(((-Ncell)*dx:dx:(Ncell)*dx),((-Ncell)*dx:dx:(Ncell)*dx),(((deltav_2D))))
...
deltaT_2D = vec(deltaT_2D[Nhalf_box:Npoint-Nhalf_box,Nhalf_box:Npoint-Nhalf_box])
deltad_2D = vec(deltad_2D[Nhalf_box:Npoint-Nhalf_box,Nhalf_box:Npoint-Nhalf_box])
deltav_2D = vec(deltav_2D[Nhalf_box:Npoint-Nhalf_box,Nhalf_box:Npoint-Nhalf_box])
...
println("max", maximum(deltad_2D), " ", maximum(deltav_2D))
