...
output1=string("/home/marco/Scrivania/Ettori_project/",name[l],"/01_radial_filtering/new_z_",name[l],"_2D_radial_filtering_fluctuations_radial_trend.txt")
...
#output1=string("/home/marco/Scrivania/Ettori_project/", name[l],"/01_radial_filtering/x", name[l],"_2D_radial_filtering_slope_radial_trend.txt")
#out1=open(output1,"w") do out1
