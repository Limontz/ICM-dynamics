...
file1=string(main,"IT90_0/01_radial_filtering/IT90_0_2D_radial_filtering_slope_radial_trend.txt")
file2=string(main,"IT90_1/01_radial_filtering/IT90_1_2D_radial_filtering_slope_radial_trend.txt")
file3=string(main,"IT90_2/01_radial_filtering/IT90_2_2D_radial_filtering_slope_radial_trend.txt")
file4=string(main,"IT90_3/01_radial_filtering/IT90_3_2D_radial_filtering_slope_radial_trend.txt")
file5=string(main,"IT90_4/01_radial_filtering/IT90_4_2D_radial_filtering_slope_radial_trend.txt")
file6=string(main,"IT92_0/01_radial_filtering/IT92_0_2D_radial_filtering_slope_radial_trend.txt")
file7=string(main,"IT92_1/01_radial_filtering/IT92_1_2D_radial_filtering_slope_radial_trend.txt")
file8=string(main,"IT92_2/01_radial_filtering/IT92_2_2D_radial_filtering_slope_radial_trend.txt")
...
d_t_mean, d_t_sigma=(mean(Array(slope_d_t[:,2:9]), dims=2)), std(Array(slope_d_t[:,3:9]), dims=2)
...
ylabel(L"(\delta T / \delta \rho)_{2D}",fontsize=15)
xticks(fontsize=15)
yticks(fontsize=15)
...
ylabel(L"(\delta v / \delta \rho)_{2D}",fontsize=15)
xticks(fontsize=15)
yticks(fontsize=15)
frame = gca()
frame.axes.xaxis.set_ticklabels([])
...
ylabel(L"(\delta v^2 / \delta T)_{2D}",fontsize=15)
