...
println(slope_d_t)
d_t_mean, d_t_sigma=(mean(Array(slope_d_t[:,3:9]), dims=2)), std(Array(slope_d_t[:,3:9]), dims=2)


d_v_mean, d_v_sigma=(mean(Array(slope_d_v[:,3:9]), dims=2)), std(Array(slope_d_v[:,3:9]), dims=2)
t_v_mean, t_v_sigma=(mean(Array(slope_t_v[:,3:9]), dims=2)), std(Array(slope_t_v[:,3:9]), dims=2)
